...
def predict_ner(model ,  scaler , sentence):
    pred, tokens, features = make_predictions(model, scaler, sentence)
    annotated = []
...
#     print(predict_ner(model_rbf, scaler, example))
#     print(predict_ner(model_linear, scaler, example))





# https://storage.googleapis.com/drive-bulk-export-anonymous/20231129T181434.045Z/4133399871716478688/603d0213-d1a2-4f01-a458-9da257b93f82/1/1e1f6fc4-da79-42f6-bc50-50adce330786?authuser

# https://storage.googleapis.com/drive-bulk-export-anonymous/20231129T181540.256Z/4133399871716478688/6ef9790e-4197-4351-bd62-3682ede4b3a7/1/f31b081f-48f3-4393-9797-9965bf8ba534?authuser
